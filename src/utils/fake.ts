...
const PASSWORD = 'Phuc#0122'
// ID của tài khoản của mình, dùng để follow người khác
const MYID = new ObjectId('654b353c93c0f0cec7c6e543')
...
const checkAndCreateHashtags = async (hashtags: string[]) => {
  ...
  return hashtagDocuemts.map((hashtag: any) => (hashtag.value as WithId<Hashtag>)._id.toString())
}
